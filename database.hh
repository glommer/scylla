...
public:
    ...
    future<> seal_active_memtable(flush_behavior behavior = flush_behavior::delayed) {
...
private:
    ...
    timer<> _delayed_streaming_flush{[this] { seal_active_streaming_memtable(memtable_list::flush_behavior::immediate); }};
    future<> seal_active_streaming_memtable_delayed();
    future<> seal_active_streaming_memtable_immediate();
    future<> seal_active_streaming_memtable(memtable_list::flush_behavior behavior = memtable_list::flush_behavior::delayed) {
