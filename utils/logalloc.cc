...
region_group::region_group(region_group&& o) noexcept
        : _parent(o._parent), _total_memory(o._total_memory), _throttle_threshold(o._throttle_threshold)
...
void region_group::do_release_requests() {
    ...
    later().then([this] {
        ...
        // point (for instance, a foreign notification)
