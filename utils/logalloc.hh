...
private:
    ...
    void subscribe_for_ancestor_available_memory_notification(region_group *ancestor) {
        ...
        with_gate(_asynchronous_gate, [this, ancestor] {
            return do_until([this] { return _waiting_on_ancestor == nullptr; }, [this] {
    ...
    uint64_t maximal_score() const {
        return _maximal_rg ? _maximal_rg->top_region_evictable_space() : 0;
    }
