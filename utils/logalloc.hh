...
public:
    ...
    //
    // Tries to reclaim given amount of bytes in total using all compatible and evictable
    // regions. Returns the number of bytes actually reclaimed. That value may be
    // smaller than requested when evictable pools are empty and
...
public:
    ...
    // Changes the compactibility state of this region. When region is not compactible, it won't be considered
    // by reclaim().
    // By default region is compactible after construction.
