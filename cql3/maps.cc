...
maps::value
maps::value::from_serialized(bytes value, map_type type, int version) {
    try {
...
bytes
maps::value::get_with_protocol_version(int protocol_version) {
...
bool
maps::literal::equals(map_type mt, const value& v) {
...
bool
maps::literal::contains_bind_marker() const {
