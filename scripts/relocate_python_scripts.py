...
def fixup_scripts_in_directory_into_archive(ar, python3_path, scripts_directory):
    fixup_scripts_in_directory(TarFileFixup(python3_path, ar), scripts_directory)

def fixup_scripts_in_directory_into_directory(output_directory, python3_path, scripts_directory):
    fixup_scripts_in_directory(FilesystemFixup(python3_path, output_directory), scripts_directory)
