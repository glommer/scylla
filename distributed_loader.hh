...
#include <functional>
#include "seastarx.hh"
#include "sstables/compaction.hh" // for sstables::creator_fn
...
public:
    static future<> reshard(sharded<sstables::sstable_directory>& dir, sharded<database>& db, sstring ks_name, sstring table_name, sstables::creator_fn creator);
