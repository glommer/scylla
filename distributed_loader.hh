...
public:
    static future<> reshape(sharded<sstables::sstable_directory>& dir, sharded<database>& db, unsigned reshape_threshold, sstring ks_name, sstring table_name, sstables::compaction_sstable_creator_fn creator);
    ...
    static future<size_t> load_new_sstables(sstables::sstable_directory& dir,
