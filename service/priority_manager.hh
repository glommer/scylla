...
extern distributed<priority_manager> _the_priority_manager;
inline distributed<priority_manager>& get_priority_manager() {
        return _the_priority_manager;
}

inline priority_manager& get_local_priority_manager() {
        return _the_priority_manager.local();
}

future<> init_priority_manager();
}
