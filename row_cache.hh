...
private:
    ...
    mutation_reader make_scanning_reader(schema_ptr, const io_priority_class& pc, const query::partition_range&);
    void on_hit();
    void on_miss();
...
public:
    ...
    mutation_reader make_reader(schema_ptr, const io_priority_class& pc, const query::partition_range& = query::full_partition_range);

    mutation_reader make_reader(schema_ptr s, const query::partition_range& r = query::full_partition_range) {
        return make_reader(s, default_priority_class(), r);
    }
