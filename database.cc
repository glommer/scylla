...
column_family::column_family(schema_ptr schema, config config, db::commitlog& cl, compaction_manager& compaction_manager)
    ...
    , _streaming_memtables(make_lw_shared<memtable_list>([this] { return seal_active_streaming_memtable(); }, [this] { return new_streaming_memtable(); }, _config.max_memtable_size))
