...
database::database(const db::config& cfg, database_config dbcfg)
    ...
    , _dbcfg(dbcfg)
    , _memtable_controller(make_flush_controller(*_cfg, dbcfg.memtable_scheduling_group, service::get_local_memtable_flush_priority(), [this, limit = 2.0f * _dirty_memory_manager.throttle_threshold()] {
