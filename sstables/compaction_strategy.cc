...
class size_tiered_backlog_tracker final: public compaction_backlog_tracker::impl {
    ...
    std::unordered_map<sstables::shared_sstable, backlog_write_progress_manager*> _in_progress = {};
    std::unordered_map<sstables::shared_sstable, backlog_read_progress_manager*> _in_compaction = {};
...
public:
    ...
    virtual void remove_sstable(sstables::shared_sstable sst)  override {
        ...
        _in_compaction.erase(sst);
    }

    virtual void revert_charges(sstables::shared_sstable sst)  override {
        _in_compaction.erase(sst);
        _in_progress.erase(sst);
    }
