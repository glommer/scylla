...
public:
    ...
    virtual void on_data_write_completed(const writer_offset_tracker&) = 0;
...
struct noop_write_monitor final : public write_monitor {
    ...
    virtual void on_data_write_completed(const writer_offset_tracker&) override { }
...
public:
    ...
    virtual void on_read_completed(const reader_position_tracker&) = 0;
};

struct noop_read_monitor final: public read_monitor {
    virtual void on_read_started(const reader_position_tracker&) override {}
    virtual void on_read_completed(const reader_position_tracker&) override {}
};

read_monitor& default_read_monitor();

struct read_monitor_generator {
    virtual sstables::read_monitor& operator()(sstables::shared_sstable sst) = 0;
