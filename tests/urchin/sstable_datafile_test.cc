...
SEASTAR_TEST_CASE(datafile_generation_01) {
    ...
    return test_setup::do_with_test_directory([] {
        ...
        auto sst = make_lw_shared<sstable>("ks", "cf", "tests/urchin/sstables/tests-temporary", 1, la, big);

        auto fname = sstable::filename("tests/urchin/sstables/tests-temporary", "ks", "cf", la, 1, big, sstable::component_type::Data);
...
SEASTAR_TEST_CASE(datafile_generation_02) {
    return test_setup::do_with_test_directory([] {
        ...
        auto sst = make_lw_shared<sstable>("ks", "cf", "tests/urchin/sstables/tests-temporary", 2, la, big);

        auto fname = sstable::filename("tests/urchin/sstables/tests-temporary", "ks", "cf", la, 2, big, sstable::component_type::Data);
        return sst->write_components(*mt).then([mt, sst, s, fname] {
            return engine().open_file_dma(fname, open_flags::ro).then([] (file f) {
                auto bufptr = allocate_aligned_buffer<char>(4096, 4096);
...
SEASTAR_TEST_CASE(datafile_generation_03) {
    ...
    return test_setup::do_with_test_directory([] {
        ...
        auto sst = make_lw_shared<sstable>("ks", "cf", "tests/urchin/sstables/tests-temporary", 3, la, big);

        auto fname = sstable::filename("tests/urchin/sstables/tests-temporary", "ks", "cf", la, 3, big, sstable::component_type::Data);
        return sst->write_components(*mt).then([mt, sst, s, fname] {
            return engine().open_file_dma(fname, open_flags::ro).then([] (file f) {
                auto bufptr = allocate_aligned_buffer<char>(4096, 4096);
...
SEASTAR_TEST_CASE(datafile_generation_04) {
    ...
    return test_setup::do_with_test_directory([] {
        ...
        auto sst = make_lw_shared<sstable>("ks", "cf", "tests/urchin/sstables/tests-temporary", 4, la, big);

        auto fname = sstable::filename("tests/urchin/sstables/tests-temporary", "ks", "cf", la, 4, big, sstable::component_type::Data);
        return sst->write_components(*mt).then([mt, sst, s, fname] {
            return engine().open_file_dma(fname, open_flags::ro).then([] (file f) {
                auto bufptr = allocate_aligned_buffer<char>(4096, 4096);
...
SEASTAR_TEST_CASE(datafile_generation_05) {
    ...
    return test_setup::do_with_test_directory([] {
        ...
        auto sst = make_lw_shared<sstable>("ks", "cf", "tests/urchin/sstables/tests-temporary", 5, la, big, now);

        return sst->write_components(*mt).then([mt, sst, s] {
            auto fname = sstable::filename("tests/urchin/sstables/tests-temporary", "ks", "cf", la, 5, big, sstable::component_type::Data);
            return engine().open_file_dma(fname, open_flags::ro).then([] (file f) {
                auto bufptr = allocate_aligned_buffer<char>(4096, 4096);
...
SEASTAR_TEST_CASE(datafile_generation_06) {
    ...
    return test_setup::do_with_test_directory([] {
        ...
        auto sst = make_lw_shared<sstable>("ks", "cf", "tests/urchin/sstables/tests-temporary", 6, la, big);

        return sst->write_components(*mt).then([mt, sst, s] {
            auto fname = sstable::filename("tests/urchin/sstables/tests-temporary", "ks", "cf", la, 6, big, sstable::component_type::Data);
            return engine().open_file_dma(fname, open_flags::ro).then([] (file f) {
                auto bufptr = allocate_aligned_buffer<char>(4096, 4096);
...
SEASTAR_TEST_CASE(datafile_generation_07) {
    ...
    return test_setup::do_with_test_directory([] {
        ...
        auto sst = make_lw_shared<sstable>("ks", "cf", "tests/urchin/sstables/tests-temporary", 7, la, big);

        return sst->write_components(*mt).then([mt, sst, s] {
            auto fname = sstable::filename("tests/urchin/sstables/tests-temporary", "ks", "cf", la, 7, big, sstable::component_type::Index);
            return engine().open_file_dma(fname, open_flags::ro).then([] (file f) {
                auto bufptr = allocate_aligned_buffer<char>(4096, 4096);
...
SEASTAR_TEST_CASE(datafile_generation_08) {
    ...
    return test_setup::do_with_test_directory([] {
        ...
        auto sst = make_lw_shared<sstable>("ks", "cf", "tests/urchin/sstables/tests-temporary", 8, la, big);

        return sst->write_components(*mt).then([mt, sst, s] {
            auto fname = sstable::filename("tests/urchin/sstables/tests-temporary", "ks", "cf", la, 8, big, sstable::component_type::Summary);
            return engine().open_file_dma(fname, open_flags::ro).then([] (file f) {
                auto bufptr = allocate_aligned_buffer<char>(4096, 4096);
...
SEASTAR_TEST_CASE(datafile_generation_09) {
    ...
    return test_setup::do_with_test_directory([] {
        ...
        auto sst = make_lw_shared<sstable>("ks", "cf", "tests/urchin/sstables/tests-temporary", 9, la, big);

        return sst->write_components(*mt).then([mt, sst, s] {
            auto sst2 = make_lw_shared<sstable>("ks", "cf", "tests/urchin/sstables/tests-temporary", 9, la, big);
...
SEASTAR_TEST_CASE(datafile_generation_10) {
    ...
    return test_setup::do_with_test_directory([] {
        ...
        auto sst = make_lw_shared<sstable>("ks", "cf", "tests/urchin/sstables/tests-temporary", 10, la, big);

        return sst->write_components(*mt).then([mt, sst, s] {
            auto fname = sstable::filename("tests/urchin/sstables/tests-temporary", "ks", "cf", la, 10, big, sstable::component_type::Data);
            return engine().open_file_dma(fname, open_flags::ro).then([] (file f) {
                auto bufptr = allocate_aligned_buffer<char>(4096, 4096);
                ...
                return std::move(fut).then([f = std::move(f), bufptr = std::move(bufptr)] (size_t size) mutable {
                    ...
                    auto fname = sstable::filename("tests/urchin/sstables/tests-temporary", "ks", "cf", la, 10, big, sstable::component_type::CRC);
                    return engine().open_file_dma(fname, open_flags::ro).then([adler] (file f) {
                        ...
                        auto fname = sstable::filename("tests/urchin/sstables/tests-temporary", "ks", "cf", la, 10, big, sstable::component_type::Digest);
                        return engine().open_file_dma(fname, open_flags::ro).then([adler] (file f) {
                            auto bufptr = allocate_aligned_buffer<char>(4096, 4096);
...
SEASTAR_TEST_CASE(datafile_generation_11) {
    return test_setup::do_with_test_directory([] {
        ...
        auto sst = make_lw_shared<sstable>("ks", "cf", "tests/urchin/sstables/tests-temporary", 11, la, big);
...
SEASTAR_TEST_CASE(datafile_generation_12) {
    return test_setup::do_with_test_directory([] {
        ...
        auto sst = make_lw_shared<sstable>("ks", "cf", "tests/urchin/sstables/tests-temporary", 12, la, big);
...
static future<> sstable_compression_test(compressor c, unsigned generation) {
    return test_setup::do_with_test_directory([c, generation] {
        ...
        auto sst = make_lw_shared<sstable>("ks", "cf", "tests/urchin/sstables/tests-temporary", generation, la, big);
...
SEASTAR_TEST_CASE(datafile_generation_16) {
    return test_setup::do_with_test_directory([] {
        ...
        auto sst = make_lw_shared<sstable>("ks", "cf", "tests/urchin/sstables/tests-temporary", 16, la, big);
    ...
    return open_sstables("tests/urchin/sstables/compaction", {1,2,3}).then([s = std::move(s), generation] (auto sstables) {
        return test_setup::do_with_test_directory([sstables, s, generation] {
            auto new_sstable = [generation] {
                return make_lw_shared<sstables::sstable>("ks", "cf", "tests/urchin/sstables/tests-temporary",
...
SEASTAR_TEST_CASE(datafile_generation_37) {
    return test_setup::do_with_test_directory([] {
        ...
        auto sst = make_lw_shared<sstable>("ks", "cf", "tests/urchin/sstables/tests-temporary", 37, la, big);
        return sst->write_components(*mtp).then([s] {
...
SEASTAR_TEST_CASE(datafile_generation_38) {
    return test_setup::do_with_test_directory([] {
        ...
        auto sst = make_lw_shared<sstable>("ks", "cf", "tests/urchin/sstables/tests-temporary", 38, la, big);
        return sst->write_components(*mtp).then([s] {
...
SEASTAR_TEST_CASE(datafile_generation_39) {
    return test_setup::do_with_test_directory([] {
        ...
        auto sst = make_lw_shared<sstable>("ks", "cf", "tests/urchin/sstables/tests-temporary", 39, la, big);
        return sst->write_components(*mtp).then([s] {
...
SEASTAR_TEST_CASE(datafile_generation_40) {
    return test_setup::do_with_test_directory([] {
        ...
        auto sst = make_lw_shared<sstable>("ks", "cf", "tests/urchin/sstables/tests-temporary", 40, la, big);

        return sst->write_components(*mt).then([mt, sst, s] {
            auto fname = sstable::filename("tests/urchin/sstables/tests-temporary", "ks", "cf", la, 40, big, sstable::component_type::Data);
            return engine().open_file_dma(fname, open_flags::ro).then([] (file f) {
                auto bufptr = allocate_aligned_buffer<char>(4096, 4096);
