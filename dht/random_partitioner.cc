...
static boost::multiprecision::uint128_t token_to_cppint(token::token_view t) {
...
int random_partitioner::tri_compare(token::token_view t1, token::token_view t2) const {
